package com.example.api_auth_sample.ui.activities.login.fragments.auth.authMethod
...
class BasicAuth : Fragment(), AuthenticatorFragment {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.fragment_login_auth_auth_method_basic_auth, container, false)
