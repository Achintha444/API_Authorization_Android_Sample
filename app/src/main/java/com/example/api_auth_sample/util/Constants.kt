...
object Constants {
    ...
    const val BaseUrl: String = "https://mock.apidog.com/m1/369147-0-default";
    const val APIDogId: String = "3864484"; // 3863493, 3864484
    const val APIDogAuthId: String = "3864485"; // 3864485 3863759
